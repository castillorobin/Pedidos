...
<div ><a href="/tickets/create" class="btn btn-primary float-right" > Agregar Ticket</a></div>
<br>
...
<tbody>
    ...
    <td>{{ $ticket->casillero }}</td>
    <td>{{ $ticket->personalizado }}</td>
    <td>{{ $ticket->punto_fijo }}</td>
    <td>{{ $ticket->total }}</td>
